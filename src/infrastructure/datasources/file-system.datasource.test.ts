...
describe('FileSystemDatasource', () => {
  ...
  const logPath = path.join(__dirname, '../../../logs' ) //path relativo a donde estoy.

  beforeEach(() => { //vamos a eliminar nuestra carpeta antes que todo.
    fs.rmSync( logPath, { recursive: true, force: true });
  })

  test('should create log files if they do not exists', () => {

    new FileSystemDatasource(); //crea nuestra carpeta logs en el file system 
